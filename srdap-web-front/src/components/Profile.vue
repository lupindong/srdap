            ...
            <mdb-col md="3">
                <mdb-card cascade narrow>
                    ...
                    <mdb-card-body class="text-center">
                        ...
                        <p class="text-justify">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ratione
                            perferendis quod animi dignissimos consectetur quibusdam numquam laboriosam, minus,
                            provident...</p>
                        ...
                        <mdb-col lg="6" xl="5" class="mb-3">
                            <mdb-card cascade narrow class="d-flex mb-5">
                                ...
                                <mdb-card-body>
                                    ...
                                    <mdb-card-text>Some quick example text to build on the card title and make up the
